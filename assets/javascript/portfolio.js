...
(function () {
  ...
  $(document).ready(function () {
    ...
    if (window.mobileAndTabletCheck()) {
      $("#background").replaceWith(
        '<div id="background" style="background-image: url(https://mindiw.me/assets/images/mobile-background.jpg);"></div>'
      );
  ...
  $(document).keydown(function (event) {
    ...
    if (
      event.ctrlKey &&
      (event.keyCode === 85 || event.keyCode === 83 || event.keyCode === 65)
    ) {
      return false;
